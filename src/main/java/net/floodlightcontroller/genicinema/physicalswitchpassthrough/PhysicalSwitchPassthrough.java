...
public class PhysicalSwitchPassthrough implements IFloodlightModule, IOFSwitchListener {
	...
	public void init(FloodlightModuleContext context)
		...
		physicalSwitches.add(DatapathId.of("0d:b4:14:58:d0:ed:2e:00")); //1
		physicalSwitches.add(DatapathId.of("0d:b6:14:58:d0:ed:2e:00")); //2
		physicalSwitches.add(DatapathId.of("0d:ad:14:58:d0:ed:2e:00")); //3
		physicalSwitches.add(DatapathId.of("01:04:84:34:97:d5:62:00")); //4
		physicalSwitches.add(DatapathId.of("01:02:84:34:97:d4:6c:00")); //5
		physicalSwitches.add(DatapathId.of("01:02:6c:3b:e5:6c:c5:00")); //6
		physicalSwitches.add(DatapathId.of("01:03:6c:3b:e5:63:21:00")); //7
		physicalSwitches.add(DatapathId.of("0d:ae:14:58:d0:ed:2e:00")); //8
		physicalSwitches.add(DatapathId.of("0d:e2:6c:3b:e5:6c:c5:00")); //9
		physicalSwitches.add(DatapathId.of("01:02:84:34:97:d6:0d:00")); //10
		physicalSwitches.add(DatapathId.of("0d:af:14:58:d0:ed:2e:00")); //11
		physicalSwitches.add(DatapathId.of("06:68:6c:3b:e5:63:21:00")); //12
		physicalSwitches.add(DatapathId.of("0d:b2:14:58:d0:ed:2e:00")); //13
		physicalSwitches.add(DatapathId.of("01:02:6c:3b:e5:66:6b:00")); //14	
		physicalSwitches.add(DatapathId.of("04:9e:84:34:97:d5:c5:00")); //15
		physicalSwitches.add(DatapathId.of("06:13:84:34:97:d4:6c:00")); //16
		physicalSwitches.add(DatapathId.of("0d:b1:14:58:d0:ed:2e:00")); //17
		physicalSwitches.add(DatapathId.of("0d:cb:6c:3b:e5:66:6b:00")); //18
		physicalSwitches.add(DatapathId.of("0e:a4:84:34:97:d5:62:00")); //19
		physicalSwitches.add(DatapathId.of("02:90:84:34:97:d6:0d:00")); //20
		physicalSwitches.add(DatapathId.of("0e:8c:84:34:97:c6:c9:00")); //21
		physicalSwitches.add(DatapathId.of("0d:b5:14:58:d0:ed:2e:00")); //22
	}
